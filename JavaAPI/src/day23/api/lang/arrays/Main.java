...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Arrays.sort(persons);//실행시 예외발생, PersonVo에는 크기 비교를 할 수 있는 메서드가 존재하지 않기 때문!
		//크기 비교 메서드를 생성해서 출력시 정상적으로 출력됨
		...
		case "4":
			...
			break;
		default:
			System.out.println("메뉴는 1~4번만 입력해주세요.");
			break;
		}
		...
		//System.out.println(System.identityHashCode(persons));//해쉬코드(구별하기 위한 코드)는 운영체제가 결정한다.
