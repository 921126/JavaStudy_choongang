...
public class ThrowsEx01 {
	...
	public static void main(String[] args) {
		...
		//메서드 예외처리
		//throws구문이 붙어있는 메서드 or 생성자를 호출할 때는 예외를 대신 처리해야 한다.
		//즉 메서드안세서 예외처리를 강요할 때 사용한다.
		try {
			greeting(0);
			greeting(1);
			greeting(2);
		...
		try {
			...
			System.out.println("숫자 0인 경우에는 안되용");
		}
		System.out.println(" ---------------------------------------------");
		...
		try {
			...
			//예외의 냉용을 확인하기 위해서 catch영영에서 항상 사용한다.
			e.printStackTrace();
		}
